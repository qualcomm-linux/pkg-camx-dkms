...
#ifndef _CPASTOP_V695_110_H_
#define _CPASTOP_V695_110_H_

#define TEST_IRQ_ENABLE 0

static struct cam_camnoc_irq_sbm cam_cpas_v695_110_irq_sbm = {
	.sbm_enable = {
...
static struct cam_camnoc_specific
	cam_cpas_v695_110_camnoc_specific[] = {
	{
...
static struct cam_camnoc_err_logger_info cam695_cpas110_err_logger_offsets = {
...
static struct cam_cpas_hw_errata_wa_list cam695_cpas110_errata_wa_list = {
...
static struct cam_camnoc_info cam695_cpas110_camnoc_info = {
	.specific = &cam_cpas_v695_110_camnoc_specific[0],
	.specific_size = ARRAY_SIZE(cam_cpas_v695_110_camnoc_specific),
	.irq_sbm = &cam_cpas_v695_110_irq_sbm,
	.irq_err = &cam_cpas_v695_110_irq_err[0],
	.irq_err_size = ARRAY_SIZE(cam_cpas_v695_110_irq_err),
	.err_logger = &cam695_cpas110_err_logger_offsets,
	.errata_wa_list = &cam695_cpas110_errata_wa_list,
};

static struct cam_cpas_camnoc_qchannel cam695_cpas110_qchannel_info = {
	.qchannel_ctrl   = 0x5C,
	.qchannel_status = 0x60,
};


static struct cam_cpas_info cam695_cpas110_cpas_info = {
	.hw_caps_info = {
		.num_caps_registers = 1,
		.hw_caps_offsets = {0x8},
	},
	.qchannel_info = {&cam695_cpas110_qchannel_info},
	.num_qchannel = 1,
};
#endif /* _CPASTOP_V695_110_H_ */
